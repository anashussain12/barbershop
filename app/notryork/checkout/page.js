...
export default function CheckoutPage() {
  ...
  const services = [
    { name: "Classic Cut", price: "AED 90", duration: "40 min" },
    { name: "Beard Trim", price: "AED 60", duration: "25 min" },
    { name: "Gentleman's Package", price: "AED 150", duration: "65 min" },
    { name: "Traditional Shave", price: "AED 70", duration: "35 min" },
    { name: "Father & Son", price: "AED 130", duration: "60 min" },
    { name: "Hair Coloring", price: "AED 120", duration: "60 min" },
  ];

  const barbers = ["Fahad", "Omar", "Khalid", "Any Available Barber"];
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-gray-300 max-w-2xl mx-auto">
              ...
              your booking at our NOTRYORK location.
            </p>
          </div>
