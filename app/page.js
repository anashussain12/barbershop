    ...
    <main className="min-h-screen bg-gradient-to-b from-[#1a1a1a] via-[#262626] to-[#333333] text-white">
      ...
      {/* <div className="relative h-[60vh] w-full">
        ...
        <div className="relative z-20 h-full flex flex-col items-center justify-center px-4 text-center">
          ...
          <h1 className="text-5xl md:text-7xl font-bold mb-4 bg-gradient-to-r from-white to-gray-300 text-transparent bg-clip-text">MR.BARBER UNISEX SALON</h1>
...
<div className="relative h-[60vh] w-full overflow-hidden">
      ...
      <section className="py-20 px-6 bg-[#1a1a1a] relative">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-2xl md:text-3xl font-light italic text-gray-200 mb-8">The attention to detail and personalized service at Mr.BARBER UNISEX SALON is unmatched. It is more than a haircut—it&aposs an experience every gentleman deserves.</p>
