      ...
      <div className="relative h-[50vh] w-full">
        ...
        <div className="relative z-20 h-full flex flex-col items-center justify-center px-4 text-center">
          ...
          <p className="text-xl md:text-2xl max-w-2xl text-gray-200 mb-8">
            Premium cuts in the heart of Downtown
          </p>
          <Link
            href="/etobicokenorth/checkout"
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">Location: Etobicoke North</p>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">Phone: +1 416-749-7900</p>
                    <p className="text-gray-300">
