    ...
    <main className="min-h-screen bg-gradient-to-b from-[#1a1a1a] via-[#262626] to-[#333333] text-white">
      ...
      <div className="py-12 px-6">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <Link href="/dubai" className="text-amber-500 hover:text-yellow-400 transition-colors duration-300 flex items-center w-fit">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-gray-300 max-w-2xl mx-auto">Select your preferred service, barber, date and time to complete your booking at our Dubai location.</p>
          </div>
