  ...
  const services = [
    {
      ...
      price: "AED 120",
      duration: "45 min",
      description: "Precision cut with styling, hot towel refreshment, and scalp massage",
    ...
    },
    {
      ...
      price: "AED 80",
      duration: "30 min",
      description: "Expert beard shaping with hot towel treatment and essential oils",
    ...
    },
    {
      ...
      price: "AED 140",
      duration: "60 min",
      description: "Natural-looking color application specifically for grey coverage",
    ...
    <main className="min-h-screen bg-gradient-to-b from-[#1a1a1a] via-[#262626] to-[#333333] text-white">
      ...
      <div className="relative h-[50vh] w-full">
        ...
        <div className="relative z-20 h-full flex flex-col items-center justify-center px-4 text-center">
          <h1 className="text-5xl md:text-7xl font-bold mb-4 bg-gradient-to-r from-white to-gray-300 text-transparent bg-clip-text">DUBAI</h1>
          <p className="text-xl md:text-2xl max-w-2xl text-gray-200 mb-8">Premium cuts in the heart of Downtown</p>
          <Link href="/dubai/checkout" className="inline-block px-8 py-3 bg-gradient-to-r from-amber-500 to-yellow-400 hover:from-amber-400 hover:to-yellow-300 text-black font-bold rounded-md transition-all duration-300 transform hover:scale-105 shadow-[0_5px_15px_rgba(0,0,0,0.2)] hover:shadow-[0_5px_20px_rgba(245,158,11,0.3)]">
            BOOK APPOINTMENT
          </Link>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="inline-block text-4xl font-bold relative">
              <span className="bg-gradient-to-r from-amber-500 to-yellow-400 text-transparent bg-clip-text">OUR SERVICES</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service) => (
              ...
              >
                <div 
                  className="p-8 rounded-lg bg-gradient-to-b from-[#2d2d2d]/90 to-[#1a1a1a]/90 backdrop-blur-sm border border-white/5 group-hover:border-white/10 transition-all duration-500 relative overflow-hidden"
                >
                  <Image
                  src={service.image}
                  alt={service.name}
                  ...
                  <h3 className="text-2xl font-bold mb-2 bg-gradient-to-r from-white to-gray-300 text-transparent bg-clip-text relative z-10">{service.name}</h3>
                  <div className="flex justify-between mb-4 relative z-10">
                    <span className="text-amber-500 font-bold">{service.price}</span>
                    <span className="text-gray-400">{service.duration}</span>
                  </div>
                  <p className="text-gray-300 mb-6 relative z-10">{service.description}</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div>
              <h2 className="text-3xl font-bold mb-6">
                <span className="bg-gradient-to-r from-amber-500 to-yellow-400 text-transparent bg-clip-text">LOCATION DETAILS</span>
              </h2>
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">Sheikh Mohammed bin Rashid Blvd</p>
                    <p className="text-gray-300">Downtown Dubai, Dubai, UAE</p>
                  </div>
                </div>
            ...
            <div className="relative h-[400px] rounded-lg overflow-hidden shadow-[0_0_15px_rgba(0,0,0,0.5)]">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="bg-black/70 backdrop-blur-sm p-6 rounded-lg max-w-xs text-center">
                  <p className="text-gray-300 mb-4">Interactive map coming soon. Located in Downtown Dubai, near Dubai Mall.</p>
                  <a 
      ...
      <section className="py-20 px-6 relative">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="inline-block text-4xl font-bold relative">
              <span className="bg-gradient-to-r from-amber-500 to-yellow-400 text-transparent bg-clip-text">MEET OUR BARBERS</span>
              <div className="h-px w-24 bg-gradient-to-r from-transparent via-amber-500/40 to-transparent mx-auto mt-3"></div>
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {barbers.map((barber) => (
              <div key={barber.name} className="group">
                ...
                <h3 className="text-2xl font-bold mb-1 bg-gradient-to-r from-white to-gray-300 text-transparent bg-clip-text">{barber.name}</h3>
      ...
      <section className="py-20 px-6 bg-[#1a1a1a] relative">
        ...
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-4xl font-bold mb-6 bg-gradient-to-r from-white to-gray-300 text-transparent bg-clip-text">READY FOR THE ROYAL TREATMENT?</h2>
          <p className="text-xl text-gray-300 mb-10">Book your appointment today and experience premium grooming services at our Dubai location.</p>
      ...
      {/* Footer */}
      <div className="h-1 w-full bg-gradient-to-r from-teal-700 via-teal-500 to-teal-700"></div>
      <footer className="py-12 px-6 bg-[#05101e]">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
          <div>
            <h3 className="text-2xl font-bold mb-4 bg-gradient-to-r from-teal-400 to-cyan-300 text-transparent bg-clip-text">ROYAL BARBER</h3>
            <p className="text-gray-400 mb-4">Where gentlemen receive the royal treatment.</p>
            <div className="flex space-x-4">
              <a href="#" className="text-teal-400 hover:text-cyan-300">
          ...
          <div>
            ...
            <ul className="text-gray-400 space-y-2">
              <li>Email: dubai@royalbarber.com</li>
